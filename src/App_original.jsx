    ...
    <div className="layout-container">
      ...
      <aside className="sidebar">
        <div className="sidebar-logo">
          <span style={{ fontSize: '20px', marginRight: '8px' }}>≡ƒñû</span>
    ...
    <div className="tab-section">
      ...
      <div className="hero">
        <div className="hero-eyebrow">
          <span>Life Operating System ΓÇö Evidence Based</span>
        </div>
        ...
        <div className="char-row">
          <span className="chip s">≡ƒÆ╝ Kerja+Survey</span>
          <span className="chip k">≡ƒôÜ Kuliah Online</span>
          <span className="chip e">≡ƒÄ╡ YouTube Music</span>
          <span className="chip s">≡ƒæ¿ΓÇì≡ƒæ⌐ΓÇì≡ƒæº Keluarga+Anak</span>
          <span className="chip k" style={{ borderColor: 'var(--singa)', color: 'var(--singa)', background: '#f9731612' }}>≡ƒÄ¿ Framer Template</span>
          <span className="chip e" style={{ borderColor: 'var(--koala)', color: 'var(--koala)', background: '#06b6d412' }}>Γ£é∩╕Å CapCut</span>
        </div>
      </div>
      ...
      <div className="dashboard-grid">
        ...
        <div className="dashboard-col">
          ...
          <div className="card">
            <div className="card-header-flex">
              <h3 className="card-title">≡ƒôî Pinned Actions (Fokus Utama)</h3>
          ...
          <div className="card">
            <h3 className="card-title" style={{ marginBottom: '12px' }}>Γ£à Checklist Tugas Utama (Sistem)</h3>
            ...
            <div style={{ marginTop: '20px', borderTop: '1px solid var(--border)', paddingTop: '16px' }}>
              <h4 className="card-subtitle">ΓÜí Tugas Cepat (Urgent & Penting)</h4>
        ...
        <div className="dashboard-col">
          ...
          <div className="card">
            <h3 className="card-title">ΓÅ▒∩╕Å Deep Work Session</h3>
            ...
            <div className="trigger-note" style={{ marginTop: '16px', background: '#ef444408', border: '1px solid #ef44441a', padding: '12px', borderRadius: '8px' }}>
              <span className="trigger-title" style={{ color: 'var(--red)', fontWeight: 'bold', display: 'block', fontSize: '12px', marginBottom: '4px' }}>≡ƒÜ¿ PROTOKOL BURN OUT / STRES:</span>
          ...
          <div className="card">
            <h3 className="card-title" style={{ marginBottom: '10px' }}>≡ƒô¥ Notepad (Catatan Penting)</h3>
            <textarea 
    ...
    if (fase === 'fase1') {
      if (minggu === 'minggu1') {
        return {
          ...
          Sabtu: 'Polish keseluruhan ΓÇö animasi ringan, micro-interaction, copywriting final (masuk slot Sabtu 3 jam)',
      ...
      return {
        ...
        Sabtu: 'Framer 3 jam (polish/materi outreach ΓÇö batch, bukan harian) + Kuliah + Keluarga',
  ...
  return (
    <div className="tab-section">
      <div className="sec-header">
        <div className="sec-icon" style={{ background: '#8b5cf615' }}>≡ƒôï</div>
      ...
      {/* RPH blocks */}
      <div className="card">
        <h3 className="card-title" style={{ marginBottom: '16px' }}>ΓÜí Pembagian Kerja Harian (Weekday)</h3>
        <div className="ladder" style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
          <div className="ladder-item" style={{ gridTemplateColumns: '120px 1fr' }}>
            ...
            <div className="ladder-skill">Render & upload video sesuai jadwal batch ΓÇö <strong>TIDAK</strong> buka analytics/dashboard hari ini.</div>
          </div>
          <div className="ladder-item" style={{ gridTemplateColumns: '120px 1fr' }}>
            <div className="ladder-stage"><strong>CapCut (1 Jam)</strong></div>
            <div className="ladder-skill">Buat 3-5 template Capcut, upload langsung ΓÇö evaluasi performa hari Minggu saja.</div>
          </div>
      ...
      <div className="card">
        <h3 className="card-title" style={{ marginBottom: '16px' }}>≡ƒôà Alur Harian Terjadwal (Framer Task)</h3>
      ...
      {/* Sabtu & Minggu notes */}
      <div className="card">
        <h3 className="card-title" style={{ marginBottom: '10px' }}>ΓÜá∩╕Å Catatan Akhir Pekan</h3>
...
function TabMatrix({ store }) {
  ...
  return (
    <div className="tab-section">
      <div className="sec-header">
        <div className="sec-icon" style={{ background: '#f59e0b15' }}>≡ƒôê</div>
        <div className="sec-title">Prioritas Energi & Rencana Aksi</div>
      </div>

      {/* Covey Matrix */}
      <div className="card">
        <h3 className="card-title" style={{ marginBottom: '16px' }}>≡ƒº¡ Covey Matrix (Prioritas Tindakan)</h3>
      ...
      <div className="card">
        <h3 className="card-title" style={{ marginBottom: '12px' }}>ΓÜí Protokol Trigger & Aksi Harian (Intentions)</h3>
...
function TabTracker({ store }) {
  ...
  return (
    <div className="tab-section">
      <div className="sec-header">
        <div className="sec-icon" style={{ background: '#10b98115' }}>≡ƒôè</div>
        <div className="sec-title">Pelacakan Progres & Kebiasaan Buruk</div>
      </div>

      {/* 18. Progress Tracker */}
      <div className="card">
        <h3 className="card-title">≡ƒôê Tracker Kebiasaan Utama</h3>
            ...
            return (
              <div className="card" key={tracker.id} style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: '16px', padding: '16px 20px', marginBottom: '0', background: 'var(--s2)' }}>
                ...
                <div style={{ display: 'flex', gap: '16px', alignItems: 'center', flexWrap: 'wrap' }}>
                  ...
                  >
                    {isDoneToday ? 'Γ£ô Selesai Hari Ini' : 'Tandai Selesai'}
                  </button>
      ...
      <div className="card">
        <h3 className="card-title" style={{ marginBottom: '12px' }}>ΓÜá∩╕Å Mistake & Bad Habit Tracker</h3>
        ...
        <div className="flex-row" style={{ flexWrap: 'wrap', gap: '8px', margin: '8px 0 16px 0' }}>
          <button className="btn btn-sm btn-danger" onClick={() => store.addMistake('Skip outreach harian')}>≡ƒö┤ Skip outreach harian</button>
          <button className="btn btn-sm btn-danger" onClick={() => store.addMistake('Skip render/upload CapCut atau YT')}>≡ƒö┤ Skip render/upload CapCut atau YT</button>
          <button className="btn btn-sm btn-danger" onClick={() => store.addMistake('Buka analytics YT/CapCut di luar hari Minggu')}>≡ƒö┤ Buka analytics di luar hari Minggu</button>
          <button className="btn btn-sm btn-danger" onClick={() => store.addMistake('Ganti niche/strategi sebelum 1 siklus penuh selesai')}>≡ƒö┤ Ganti niche sebelum selesai siklus</button>
        </div>
      ...
      <div className="card">
        <h3 className="card-title">≡ƒ¢í∩╕Å Distraction Blocklist</h3>
        <p style={{ fontSize: '11px', color: 'var(--muted2)', margin: '4px 0 12px 0', lineHeight: '1.4' }}>
          <em>Note: Jika outreach dilakukan lewat Facebook Groups, pastikan akses FB tetap perlu dibuka untuk kerja ΓÇö jangan blokir total di jam kerja Framer, cukup blokir di luar jam itu.</em>
        </p>
        ...
        <div className="flex-row mt-4" style={{ flexWrap: 'wrap', gap: '8px' }}>
          {store.blocklist.map(item => (
            <span key={item} className="chip" style={{ display: 'flex', alignItems: 'center', gap: '8px', borderColor: 'var(--red)', color: 'var(--red)', background: '#ef444408' }}>
              <span>{item}</span>
              <button style={{ background: 'transparent', border: 'none', color: 'var(--red)', cursor: 'pointer', padding: 0 }} onClick={() => store.deleteBlocklistItem(item)}>├ù</button>
            </span>
          ))}
        </div>
      </div>
      ...
      <div className="card">
        <h3 className="card-title">≡ƒÄü Daily Rewards (Self-Motivation)</h3>
...
function TabReview({ store }) {
  ...
  return (
    <div className="tab-section">
      ...
      <div className="card">
        <h3 className="card-title">≡ƒôê Tangga Income ΓÇö Proyeksi Realistis</h3>
      ...
      {/* 19. Review Mingguan */}
      <div className="card">
        <h3 className="card-title">≡ƒô¥ Buat Review Mingguan</h3>
      ...
      {/* 20. Reframe Pikiran */}
      <div className="card">
        <h3 className="card-title">≡ƒöü Reframe Pikiran (Kognitif)</h3>
        <div className="form-group mt-4" style={{ background: 'var(--s2)', padding: '16px', borderRadius: '8px' }}>
          ...
          <div className="flex-row">
            ...
            <div style={{ color: 'var(--muted2)' }}>ΓåÆ</div>
        ...
        <div className="reframe-grid mt-4">
          {store.reframes.map(item => (
            <div className="rf-row" key={item.id}>
              ...
              <div className="rf-arrow">ΓåÆ</div>
      ...
      <div className="card">
        <h3 className="card-title">≡ƒôè Arsip & History Pencapaian</h3>
    ...
    <div className="card" style={{ marginTop: '24px' }}>
      ...
      <div className="research-grid" style={{ gap: '12px' }}>
        <div className="r-card c1" style={{ padding: '16px' }}>
          ...
          <div className="r-body" style={{ fontSize: '11px' }}>Format "Jika X ΓåÆ maka Y" meningkatkan follow-through 2ΓÇô3x dibanding goal biasa. Bekerja di level non-conscious habit loop.</div>
        </div>
        <div className="r-card c2" style={{ padding: '16px' }}>
          ...
          <div className="r-body" style={{ fontSize: '11px' }}>Goal yang spesifik + menantang + ada feedback menghasilkan performa 16ΓÇô25% lebih tinggi secara konsisten.</div>
        </div>
        ...
        <div className="r-card c4" style={{ padding: '16px' }}>
          ...
          <div className="r-body" style={{ fontSize: '11px' }}>Rutinitas yang diulang 60ΓÇô90 hari menjadi otomatis di basal ganglia ΓÇö membebaskan otak sadar untuk kerja kreatif.</div>
        </div>
      </div>
    </div>
  );
