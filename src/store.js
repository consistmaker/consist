...
const initialIntentions = [
  { id: 1, when: 'PAGI', trigger: 'sudah sarapan dan duduk di meja', response: 'langsung buka Suno dan generate 1 track — sebelum buka sosmed apapun.', note: 'Trigger fisik (duduk) lebih kuat dari trigger waktu. Urutan jelas = tidak ada decision fatigue.' },
